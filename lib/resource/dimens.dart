...
const SPLASH_SCREEN_LOGO_WIDTH = 120.0;
const VERIFY_SCREEN_LOGO_TEXT_HEIGHT = 80.0;
const VERIFY_BTN_HEIGHT = 52.0;
const MOVIE_DETAIL_SCREEN_SLIVER_APPBAR_HEIGHT = 400.0;
const CAST_ITEM_WIDTH = 90.0;
const BUTTON_COMMON_HEIGHT = 56.0;
